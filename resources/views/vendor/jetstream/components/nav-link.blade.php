...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-tertiary-color text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-tertiary-hover transition'
